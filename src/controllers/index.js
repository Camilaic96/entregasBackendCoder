module.exports = {
	viewsTemplateController: require('./views/viewsTemplate.controller'),
	authController: require('./auth/auth.controller'),
	productsController: require('./products/products.controller'),
	...
	loggerTestController: require('./logger/loggerTest.controller'),
};
